...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    if (cartItems.length === 0) {
      toast.error("Seu carrinho está vazio. Adicione alguns items para finalizar a compra!");
      return;
    }

    if (!user) {
      toast.error("Você precisa se autenticar antes de completar a sua compra!");
      navigate("/login");
    } else {
